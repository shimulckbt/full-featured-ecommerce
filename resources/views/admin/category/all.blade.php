                  ...
                  <div class="table-responsive">
                     <form method="post" action="{{route('create.category')}}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                           ...
                           <div class="controls">
                              <input type="category_name_en" id="category_name_en" name="category_name_en" class="form-control" required>
                        ...
                        <div class="form-group">
                           ...
                           <div class="controls">
                              <input type="category_name_bn" id="category_name_bn" name="category_name_bn" class="form-control" required>
