                  ...
                  <div class="table-responsive">
                     <form method="post" action="{{route('brand.create')}}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                           ...
                           <div class="controls">
                              <input type="text" id="brand_name_en" name="brand_name_en" class="form-control" required>
                              @error('brand_name_en')
                        ...
                        <div class="form-group">
                           ...
                           <div class="controls">
                              <input type="text" id="brand_name_bn" name="brand_name_bn" class="form-control" required>
                              @error('brand_name_bn')
                              <span class="text-danger">{{$message}}</span>
                              @enderror
                           </div>
